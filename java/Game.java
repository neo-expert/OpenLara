...
*/
    ...
    private void startLevel(DataInputStream lvl) {
/*
...
public void loadSettings(DataInputStream stream){
/*
    if (stream) {
        uint8 version;
        stream->read(version);
...
*/
    ...
    public Game(String lvlName) throws IOException{
	System.out.println("loading "+lvlName+" ...");
/*
        #ifdef DEBUG_RENDER
            Debug::init();
        #endif
...
*/
	init(new DataInputStream(new FileInputStream(lvlName)));
    }
